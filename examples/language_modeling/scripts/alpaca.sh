...
accelerate launch --num_processes 2 --num_machines 1 --multi_gpu --main_process_port 63252 extract_log.py --model_name tatsu-lab/alpaca --lora random --hessian raw --batch_size 2
...
# CUDA_VISIBLE_DEVICES=0 python compute_influence.py --model_name "$model_name" --lora random --hessian raw --split external
