...
def main(
    ...
    for i in range(num_train):
        ...
        last_epoch_name = f"../files/checkpoints/{save_name}/model_{i}/iter_4800.pt"
...
if __name__ == "__main__":
    ...
    try:
        ...
        if option == 1:
            main(data_name="qnli", do_corrupt=False, num_train=10)
            # main(data_name="qnli", do_corrupt=True, num_train=5)
        elif option == 2:
            main(data_name="sst2", do_corrupt=False, num_train=10)
            # main(data_name="sst2", do_corrupt=True, num_train=5)
        else:
