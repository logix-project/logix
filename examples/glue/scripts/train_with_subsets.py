...
def main(
    ...
    for alpha in alpha_list:
        ...
        for i in range(num_train):
            last_epoch_name = f"../files/subset_checkpoints/data_{data_name}/alpha_{alpha_str}/model_{i}/iter_4800.pt"
...
if __name__ == "__main__":
    ...
    try:
        ...
        if option == 1:
            main(data_name="qnli", num_train=10)
        elif option == 2:
            main(data_name="sst2", num_train=10)
        elif option == 3:
